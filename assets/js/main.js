...
const sr = ScrollReveal({
    ...
    duration:2000,
    delay:300,
    // reset:true, //To Repeate Animation
})

sr.reveal('.services__swiper,.footer__container, .footer__copy')
sr.reveal('.home__shape',{origin: 'bottom'})
sr.reveal('.home__camera',{delay: 1000, distance: '200px', duration:1500})
sr.reveal('.home__roll-1, .home__roll-2',{delay: 2200, scale:0, duration:1500, rotate:{z:180}})
sr.reveal('.home__rollstrip-1, .home__rollstrip-2',{delay: 2600, scale:0, duration:1500, rotate:{z:180}})
